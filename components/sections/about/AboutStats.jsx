...
const stats = [
  { icon: FiUsers, value: 50, suffix: "+", label: "Team Members" },
  { icon: FiCode, value: 150, suffix: "+", label: "Projects Delivered" },
  { icon: FiGlobe, value: 25, suffix: "+", label: "Countries Served" },
...
export default function AboutStats() {
  ...
  return (
    <section ref={ref} className="relative w-full bg-gray-50 dark:bg-[#0c0c0f] py-16 overflow-hidden">
      <ParticleBackground />
          ...
          {stats.map((stat, i) => {
            ...
            return (
              <div key={i} style={t(i * 100 + 200)}>
                <div className="group relative text-center p-6 bg-white dark:bg-[#111114] border border-gray-100 dark:border-white/[0.06] hover:border-orange-500/30 transition-all duration-400 cursor-default" style={{ borderRadius: "4px" }}>
