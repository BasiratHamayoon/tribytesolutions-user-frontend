...
const team = [
  { id: 1, name: "Michael Patel", role: "CEO & Founder", image: "/team/t1.jpg", socials: { linkedin: "#", twitter: "#", github: "#" } },
  { id: 2, name: "Emily Thompson", role: "CTO", image: "/team/t2.jpg", socials: { linkedin: "#", twitter: "#", github: "#" } },
  { id: 3, name: "Samantha Lee", role: "Head of Design", image: "/team/t3.jpg", socials: { linkedin: "#", twitter: "#", github: "#" } },
  { id: 4, name: "Christopher Nguyen", role: "Lead Engineer", image: "/team/t4.jpg", socials: { linkedin: "#", twitter: "#", github: "#" } },
];
    ...
    <section ref={ref} className="relative w-full bg-white dark:bg-[#09090b] py-20 lg:py-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
        <div className="text-center mb-14">
          ...
          <div style={t(300)}>
            <p className="mt-3 text-[14px] text-gray-500 dark:text-gray-400 max-w-md mx-auto leading-relaxed">
              The experienced team guiding our vision and driving innovation.
            </p>
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {team.map((member, i) => (
            <div key={member.id} style={t(i * 100 + 400)}>
              <div className="group relative overflow-hidden bg-gray-50/50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/[0.06] hover:border-orange-500/30 transition-all duration-400 cursor-default" style={{ borderRadius: "4px" }}>
                <div className="relative w-full h-[260px] overflow-hidden">
                  <Image src={member.image} alt={member.name} fill className="object-cover object-top transition-transform duration-700 group-hover:scale-110" sizes="300px" />
                  ...
                  <div className="absolute bottom-3 left-0 right-0 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 translate-y-3 group-hover:translate-y-0 transition-all duration-400">
                    {[
                      ...
                      <a key={j} href={href} className="w-7 h-7 bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center text-white hover:bg-orange-500 hover:border-orange-500 transition-all duration-300 cursor-pointer active:scale-90" style={{ borderRadius: "3px" }}>
