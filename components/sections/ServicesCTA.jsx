          ...
          <div className="relative z-10">
            ...
            <div style={t(250)}>
              <h2 className="font-heading font-bold text-2xl sm:text-3xl lg:text-4xl text-white tracking-[-0.03em] mb-4 max-w-lg mx-auto">
                ...
                <span className="text-orange-500">digital product</span>
              </h2>
            </div>

            <div style={t(400)}>
              <p className="text-[14px] text-white/70 max-w-md mx-auto mb-8 leading-relaxed">
                Tell us about your project and we&apos;ll assemble the perfect
                team to bring it to life.
              </p>
            </div>
            ...
            <div style={t(550)}>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link
                  href="/#contact"
                  className="group inline-flex items-center gap-2 px-6 py-2.5 bg-orange-500 hover:bg-orange-600 text-white text-[12.5px] font-bold transition-all duration-300 hover:-translate-y-[1px] active:scale-[0.98] cursor-pointer"
                ...
                <Link
                  href="/#portfolio"
                  className="inline-flex items-center gap-2 px-6 py-2.5 border-[1.5px] border-white/20 text-white/90 text-[12.5px] font-bold transition-all duration-300 hover:border-orange-500/50 hover:text-white hover:-translate-y-[1px] active:scale-[0.98] cursor-pointer"
                  style={{ borderRadius: "4px" }}
                >
                  View our work
                </Link>
