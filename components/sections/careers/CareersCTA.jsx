      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
        <div className="relative p-10 sm:p-14 border border-white/[0.08] overflow-hidden text-center" style={{ borderRadius: "4px", ...t(0) }}>
          <div className="absolute inset-0 z-0">
            <Image src="/slides/7.jpg" alt="CTA background" fill className="object-cover" sizes="100vw" />
          ...
          <div className="relative z-10">
            <div style={t(100)}>
              <div className="inline-flex items-center gap-2 mb-4">
                ...
                <span className="text-[10px] font-extrabold text-orange-500 tracking-[0.2em] uppercase">Don&apos;t see your role?</span>
                <span className="w-6 h-[2px] bg-orange-500 rounded-full" />
              </div>
            </div>
            ...
            <div style={t(400)}>
              <p className="text-[14px] text-white/70 max-w-md mx-auto mb-8 leading-relaxed">
                Send us your resume and tell us what excites you. If there&apos;s a fit, we&apos;ll reach out.
              </p>
            </div>
            ...
            <div style={t(550)}>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <Link href="/about" className="inline-flex items-center gap-2 px-6 py-2.5 border-[1.5px] border-white/20 text-white/90 text-[12.5px] font-bold transition-all duration-300 hover:border-orange-500/50 hover:text-white hover:-translate-y-[1px] active:scale-[0.98] cursor-pointer" style={{ borderRadius: "4px" }}>
                  About us
                </Link>
              </div>
            </div>
