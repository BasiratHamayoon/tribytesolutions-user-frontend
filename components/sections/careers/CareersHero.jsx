...
const slides = [
  { id: 1, src: "/slides/11.jpg", alt: "Join Our Team" },
  { id: 2, src: "/slides/12.jpg", alt: "Our Culture" },
  { id: 3, src: "/slides/13.jpg", alt: "Work With Us" },
];
          ...
          <div className="flex flex-col items-center max-w-3xl mx-auto">
            <div style={t(100)}>
              <div className="inline-flex items-center gap-2 mb-4">
                ...
                <span className="text-[11px] font-semibold text-orange-500">Careers</span>
              </div>
            </div>
            ...
            <div style={t(200)}>
              <div className="inline-flex items-center gap-2.5 mb-4">
                ...
                <span className="text-[10px] font-extrabold text-orange-400 tracking-[0.2em] uppercase">We&apos;re hiring</span>
                <span className="w-7 h-[2px] bg-orange-500 rounded-full" />
              </div>
            </div>
            ...
            <div style={t(500)}>
              <p className="text-[14px] sm:text-[15px] text-white/50 leading-[1.7] max-w-[500px] mx-auto mb-6">
                Join a team of passionate builders, innovators, and problem solvers. We&apos;re looking for talented people to shape the future of technology.
              </p>
            </div>

            <div style={t(640)}>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2.5">
                <Link href="#openings" className="group inline-flex items-center gap-2 px-5 py-2 rounded-[4px] bg-white text-gray-900 text-[12.5px] font-bold transition-all duration-300 hover:bg-gray-100 hover:-translate-y-[1px] active:scale-[0.98] cursor-pointer">
                  View open roles
