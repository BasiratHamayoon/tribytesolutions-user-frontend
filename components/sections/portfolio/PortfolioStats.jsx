...
import { FiCode, FiUsers, FiGlobe, FiStar } from "react-icons/fi";
...
const stats = [
  ...
  { icon: FiUsers, value: 50, suffix: "+", label: "Happy Clients" },
  { icon: FiGlobe, value: 25, suffix: "+", label: "Countries" },
  { icon: FiStar, value: 98, suffix: "%", label: "Satisfaction" },
];
