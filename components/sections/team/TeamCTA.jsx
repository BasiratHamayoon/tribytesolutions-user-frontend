...
export default function TeamCTA() {
  ...
  return (
    <section ref={ref} className="relative w-full bg-white dark:bg-[#09090b] py-20 overflow-hidden">
      <ParticleBackground />
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-6 sm:px-10 lg:px-16">
        <div className="relative p-10 sm:p-14 border border-white/[0.08] overflow-hidden text-center" style={{ borderRadius: "4px", ...t(0) }}>
          <div className="absolute inset-0 z-0">
            <Image src="/slides/7.jpg" alt="Join our team" fill className="object-cover" sizes="100vw" />
          ...
          <div className="relative z-10">
            <div style={t(100)}>
              <div className="inline-flex items-center gap-2 mb-4">
                ...
                <span className="text-[10px] font-extrabold text-orange-500 tracking-[0.2em] uppercase">Join us</span>
                <span className="w-6 h-[2px] bg-orange-500 rounded-full" />
              </div>
            </div>
            ...
            <div style={t(250)}>
              <h2 className="font-heading font-bold text-2xl sm:text-3xl lg:text-4xl text-white tracking-[-0.03em] mb-4 max-w-lg mx-auto">
                ...
                <span className="text-orange-500">amazing team</span>?
              </h2>
            </div>
            ...
            <div style={t(550)}>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link href="/careers" className="group inline-flex items-center gap-2 px-6 py-2.5 bg-orange-500 hover:bg-orange-600 text-white text-[12.5px] font-bold transition-all duration-300 hover:-translate-y-[1px] active:scale-[0.98] cursor-pointer" style={{ borderRadius: "4px" }}>
                  View open roles
                  <FiArrowRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform duration-300" />
                </Link>
                <Link href="/#contact" className="inline-flex items-center gap-2 px-6 py-2.5 border-[1.5px] border-white/20 text-white/90 text-[12.5px] font-bold transition-all duration-300 hover:border-orange-500/50 hover:text-white hover:-translate-y-[1px] active:scale-[0.98] cursor-pointer" style={{ borderRadius: "4px" }}>
                  Contact us
                </Link>
              </div>
            </div>
